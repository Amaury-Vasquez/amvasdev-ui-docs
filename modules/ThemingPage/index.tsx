...
import ComponentVariantSystem from "./ComponentVariantSystem";
...
const ThemingPage = () => (
  <div className="flex flex-col gap-12 p-4 md:p-8">
    {/* Header */}
    <div>
      <h1 className="text-2xl md:text-4xl font-bold mb-4">Theming Guide</h1>
    ...
    <section className="space-y-4">
      ...
      <div className="space-y-4">
        ...
        <div className="p-6 bg-base-200 rounded-lg">
          ...
          <p className="text-base-content/70">
            Store the user&apos;s theme choice in localStorage so it persists
            across sessions.
          </p>
        </div>
