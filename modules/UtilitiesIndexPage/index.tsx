...
const UtilitiesIndexPage = () => {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 md:gap-8 md:p-8">
      <div>
        <h1 className="text-2xl md:text-4xl font-bold mb-4">Utilities</h1>
      ...
      <div className="p-6 bg-base-200 rounded-lg">
        <h2 className="text-xl md:text-2xl font-semibold mb-3">Why Use Utilities?</h2>
