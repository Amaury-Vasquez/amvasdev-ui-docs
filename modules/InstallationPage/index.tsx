...
const InstallationPage = () => (
  <div className="flex flex-col gap-4 p-4 md:gap-8 md:p-8">
    {/* Header */}
    <div>
      <h1 className="text-2xl md:text-4xl font-bold mb-4">Installation</h1>
    ...
    <section className="space-y-4">
      ...
      <p className="text-base-content/80">
        Import the CSS file in your application&apos;s entry point or root
        layout:
      </p>
  ...
  function App() {
    ...
    <section className="space-y-4">
      ...
      <p className="text-base-content/80">
        amvasdev-ui is written in TypeScript and includes full type definitions.
        No additional setup is required for TypeScript projects. You&apos;ll get
        automatic type checking and autocomplete in your IDE.
      </p>
      <div className="mockup-code">
        <pre>
          <code>
    ...
    <section className="space-y-4">
      ...
      <div className="space-y-4">
        <div className="p-6 bg-base-200 rounded-lg">
          ...
          <p className="text-base-content/70 mb-2">
            Make sure you&apos;ve imported the CSS file and configured Tailwind
            CSS with DaisyUI. Check that the import statement is in your root
        ...
        <div className="p-6 bg-base-200 rounded-lg">
          ...
          <p className="text-base-content/70 mb-2">
            Ensure you&apos;re using compatible versions of React and
            TypeScript. The library requires React 18+ and TypeScript 4.5+.
          </p>
        </div>
        ...
        <div className="p-6 bg-base-200 rounded-lg">
          ...
          <p className="text-base-content/70 mb-2">
            If you&apos;re experiencing style conflicts, make sure the
            amvasdev-ui CSS is imported after your global styles. You can also
            use CSS modules or CSS-in-JS solutions to scope your styles.
          </p>
        </div>
      </div>
    </section>
