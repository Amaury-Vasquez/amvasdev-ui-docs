...
export default function LoadingUtilitiesPage() {
  const [selectedType, setSelectedType] = useState<(typeof TYPES)[number]>("spin");
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-2xl font-semibold mb-4">All Loading Types</h2>
            ...
            {TYPES.map((type) => (
              <div key={type} className="text-center">
                <div className="flex items-center justify-center p-6 bg-base-300 rounded mb-2">
                  <span
                    className={`loading ${getLoadingClasses({ type, size: "lg" })}`}
                  />
                </div>
